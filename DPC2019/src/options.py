...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--channels', type=int, default=3, help='number of channels created by the patch-wise network that feeds into the image-wise network (default: 1)')
